...
@oslc_name("LinkType")
@oslc_resource_shape(describes=NS_OSLC_AM["LinkType"], title="LinkType Shape")
class LinkType(OSLCResource):
    ...
    def __init__(self, **kwargs):
        ...
        # End of user code
        @oslc_name("comment")
        @oslc_property_definition(rdfs_vocabulary_constants.NS_RDFS["comment"])
        @oslc_description("May be used to provide a human-readable description of a resource.")
        @oslc_occurs(Occurs.EXACTLY_ONE)
        ...
        # End of user code
        @oslc_name("label")
        @oslc_property_definition(rdfs_vocabulary_constants.NS_RDFS["label"])
        @oslc_description("May be used to provide a human-readable version of a resource's name.")
        @oslc_occurs(Occurs.ZERO_OR_ONE)
        @oslc_value_type("XMLLiteral")
        @oslc_read_only(False)
        def label(self):
