...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Resource Property Value Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see adaptorinterface.AdaptorinterfacePackage#getResourcePropertyValueType()
 * @model
 * @generated
 */
public enum ResourcePropertyValueType implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>Local Resource</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #LOCAL_RESOURCE_VALUE
	 * @generated
	 * @ordered
	 */
	LOCAL_RESOURCE(5, "LocalResource", "LocalResource"),
	...
	/**
	 * The '<em><b>Local Resource</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Local Resource</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #LOCAL_RESOURCE
	 * @model name="LocalResource"
	 * @generated
	 * @ordered
	 */
	public static final int LOCAL_RESOURCE_VALUE = 5;
	...
	/**
	 * An array of all the '<em><b>Resource Property Value Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ResourcePropertyValueType[] VALUES_ARRAY =
		new ResourcePropertyValueType[] {
			BOOLEAN,
			STRING,
			DATE_TIME,
			XML_LITERAL,
	...
	/**
	 * A public read-only list of all the '<em><b>Resource Property Value Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ResourcePropertyValueType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static ResourcePropertyValueType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ResourcePropertyValueType result = VALUES_ARRAY[i];
	...
	public static ResourcePropertyValueType get(int value) {
		switch (value) {
			...
			case LOCAL_RESOURCE_VALUE: return LOCAL_RESOURCE;
	 ...
	 * @generated
	 */
	private ResourcePropertyValueType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
