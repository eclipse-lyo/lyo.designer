...
public interface RdfsDomainConstants
{
    ...
    public static String TERM_PATH = "term";
    public static String TERM_NAMESPACE = RDFS_NAMSPACE; //namespace of the rdfs:class the resource describes
    public static String TERM_LOCALNAME = "Term"; //localName of the rdfs:class the resource describes
    public static String TERM_TYPE = TERM_NAMESPACE + TERM_LOCALNAME; //fullname of the rdfs:class the resource describes
