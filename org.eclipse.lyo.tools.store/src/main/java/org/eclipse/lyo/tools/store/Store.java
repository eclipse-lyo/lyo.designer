...
public interface Store {
     ...
     *
     * @param namedGraphUri URI of a named graph that shall be a valid URI and was used before
     *                      with the
     ...
     * @throws StoreAccessException
     * @throws ModelUnmarshallingException
     */
     ...
     * @return A collection of {@link IResource} instances, unmarshaled from the RDF
     * graph persisted in the triplestore.
     *
     ...
     * @return An {@link IResource} instance, unmarshaled from the RDF
     * graph persisted in the triplestore.
     *
     * @throws NoSuchElementException      if the resource is not present under a given
